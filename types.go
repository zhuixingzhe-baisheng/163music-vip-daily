...
type Config struct {
	...
	YunbeiSign          bool   `json:"YunbeiSign"`
	VipSign             bool   `json:"VipSign"`
	VipListen           bool   `json:"VipListen"`
	VipPlaylistID       int    `json:"VipPlaylistID"`
	VipSongLike         bool   `json:"VipSongLike"`
	VipSongLikeIDs      []int  `json:"VipSongLikeIDs"`
	ShowVipTaskList     bool   `json:"ShowVipTaskList"`
}
